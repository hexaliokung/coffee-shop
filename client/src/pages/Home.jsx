    ...
    <div className="home-container">
      <section className="hero-section">
        <div className="hero-content">
          ...
          <button className="cta-button text-xl font-semibold text-white bg-gradient-to-r from-amber-500 to-orange-400 hover:opacity-90 px-8 py-4 rounded-full shadow-lg" onClick={handleMenuClick}>
            ☕ เริ่มต้นความอร่อยวันนี้ — สมัครเลย!
          </button>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {products.map((item) => (
                <MenuCard key={item.id} onClick={handleMenuClick}>
      ...
      <section className="about-preview">
        <div className="about-content">
          ...
          <p>
            ร้านกาแฟของเราเริ่มต้นขึ้นในปี พ.ศ. 2467 ด้วยความมุ่งมั่นที่จะสร้างประสบการณ์กาแฟที่ดีที่สุด <br />
